  ...
  return (
    <Card className="shadow-none">
      <div className="space-y-6">
        <div className="flex gap-x-6 justify-between px-4">
          <div>
            <span className="text-sm text-gray-500">Appointment ID</span>
            <p className="text-xl font-medium"># {record.id}</p>
          </div>
          {index === 0 && (
            <div className="px-4 flex items-center justify-center text-center bg-blue-100 rounded-full font-semibold text-blue-600">
              <span>Recent</span>
            </div>
          )}
          <div>
