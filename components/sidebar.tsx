    ...
    <div className='w-full p-4 flex flex-col justify-between gap-4 bg-white overflow-y-scroll min-h-full'>
      <div className=''>
        <div className='flex items-center justify-center lg:justify-start gap-2'>
          ...
          <Link href={`/`} className='hidden lg:flex text-base 2xl:text-xl font-bold'>Emran HMS</Link>
        </div>

        <div className='mt-4 text-sm'>
          {SIDEBAR_LINKS.map((el) => (
            <div key={el.label} className='flex flex-col gap-2'>
              <span className='hidden lg:block uppercase text-gray-400 font-bold my-4'>
                {el.label}
              </span>
