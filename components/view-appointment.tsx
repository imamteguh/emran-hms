  ...
  return (
    <Dialog>
      <DialogTrigger asChild>
        <Button
          variant="outline"
          className="flex items-center justify-center rounded-full bg-blue-500/10 hover:underline 
          text-blue-600 px-1.5 py-1 text-xs md:text-sm"
        >
          View
        </Button>
      </DialogTrigger>
      ...
      <DialogContent className="max-w-[425px] max-h-[95%] md:max-w-2xl 2xl:max-w-3xl p-8 overflow-y-auto">
        <>
          ...
          <div className="grid grid-cols-1 gap-4 py-4">
            <p className="w-full p-2 bg-blue-100 text-blue-600 rounded text-xs md:text-sm">
            ...
            <div className="grid grid-cols-3 gap-10 px-1">
              <div>
            ...
            <p className="w-full bg-blue-100 text-blue-600 p-2 rounded text-xs md:text-sm mt-16">
            ...
            {((await checkRole("ADMIN")) || data?.doctor_id === userId) && (
              <>
                <p className="w-full bg-blue-100 text-blue-600 p-2 rounded text-xs md:text-sm mt-4">
                  Perform Action
                </p>
