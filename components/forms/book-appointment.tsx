        ...
        {loading ? (
          ...
          <div className="h-full overflow-y-auto p-4">
            ...
            <Form {...form}>
              ...
              >
                <div className="w-full rounded-md border border-input bg-background px-3 py-2 flex items-center gap-4">
                  <ProfileImage
                    url={data?.img!}
                    name={patientName}
                    className="size-16 border border-input bg-blue-500"
                  />
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      >
                        <FormControl>
                          <SelectTrigger className="w-full ps-1 py-6 text-start">
