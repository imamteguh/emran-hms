  ...
  const renderRow = (item: Appointment) => {
    ...
    return (
      <tr key={item?.id} className="border-b border-gray-200 even:bg-slate-50 text-sm hover:bg-slate-50">
        <td>
          <div className="flex items-center gap-2 2xl:gap-4 py-2 xl:py-4">
            <ProfileImage
            ...
            />
            <div>
              <h3 className="text-sm md:text-base md:font-medium uppercase truncate">
                {name}
              </h3>
        ...
        <td className="hidden md:table-cell">
          <div className="flex items-center gap-2 2xl:gap-4 py-2 xl:py-4">
            ...
            />
            <div>
              <h3 className="font-medium uppercase truncate">{item?.doctor?.name}</h3>
              <span className="text-xs capitalize">
